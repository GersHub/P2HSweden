...
for s in scen:
    wind_yr = [2011, 2012, 2013, 2014, 2015]
    ...
    for y in wind_yr:
        ...
        print 'Wind yr : {}'.format(y)
        if y == 2014:
            filename = 'Scen_{}'.format(s)
        else:
            filename = 'Scen_{}_wind_yr_{}'.format(s, y)
        ...
        p2h['Wind Year {}'.format(y)] = result
            
    plot_compare_scenarios(p2h, 'Scen_{}_wind'.format(s))
    ...
    print ''
    print '2013:', p2h_tot['Wind Year 2013'], '({} % more than for 2014)'.format((p2h_tot['Wind Year 2013'] - p2h_2014)/p2h_2014 * 100)
    print '2015:', p2h_tot['Wind Year 2015'], '({} % less than for 2014)'.format((p2h_2014 - p2h_tot['Wind Year 2015'])/p2h_2014 *100)
